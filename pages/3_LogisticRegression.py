...
cm_plot_path = "./plots/logistic_confusion_matrix.jpg"  # Define the path to save the image
...
plt.legend()
roc_plot_path = "./plots/logistic_roc_curve.jpg"  # Define the path to save the image
